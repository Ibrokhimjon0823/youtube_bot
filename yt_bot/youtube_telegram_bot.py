...
def download_video(update: Update, context: CallbackContext, url, download_type, processing_msg):
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        token = os.getenv("7526573148:AAFKVZQgsINhYaGAloaxnLRm7wN9c4aYVFM")
        if not token:
            self.stdout.write(
